    ...
    <ul class="nav" id="side-menu">
        ...
        <li <?php echo (in_array($tth,$active) || in_array($tth,$active2)) ? 'class="active"' : ''?> >
            ...
            <ul class="nav nav-second-level">
                <?php
                $icon = array('fa-newspaper-o', 'fa-image', 'fa-bookmark', 'fa-puzzle-piece', 'fa-send-o', 'fa-tags', 'fa-rotate-right', 'fa-clock-o');
                $db->table = "category_type";
                $db->condition = "is_active = 1";
                $db->order = "sort ASC";
                $rows = $db->select();
                ...
                ?>  
                    <li><a <?php echo ($tth=='users')?'class="active"':''?> href="?ol=users"><i class="fa fa-user  fa-fw"></i><span>Quản lý khách hàng đăng nhập</span></a></li>
	          <li>
...
<!--    <li <?php echo (in_array($tth,$active6))?'class="active"':''?> >
	        ...
	        <ul class="nav nav-second-level">
                <li>
                    <a <?php echo ($tth == 'tool_ckfinder')? 'class="active"':''?> href="?<?php echo TTH_PATH?>=tool_ckfinder"><i class="fa fa-folder-open fa-fw"></i> <span>Thư viện - Media</span></a>
                </li>
		        <li>
