...
// Database info
define("TTH_DB_HOST", $CONFIG[$qr]['tth_db_host']);
define("TTH_DB_USER", $CONFIG[$qr]['tth_db_user']);
define("TTH_DB_PASS", $CONFIG[$qr]['tth_db_pass']);
define("TTH_DB_NAME", $CONFIG[$qr]['tth_db_name']);
