...
if(isset($_POST['forgot_user_email'])) {
	...
	if($db->RowCount>0) {
		...
		$subject = "[Olala Web] Thiết lập lại mật khẩu từ ".$domain;
		$message = 'Chào '.$rows[0]['user_name'].',<br/><br/>'.
				...
				'Hỗ trợ kỹ thuật (24/7): (+84) 974 779 085 -  Email: info@olalaweb.vn<br/><br/>'.
				'-----<br/><a href="http://olalaweb.vn/" title="Olala Web | Olala Group"><font face="arial, helvetica, sans-serif" style="color: #3b699a; font-weight: bold;">Olala Web | Olala Group</font></a>';
