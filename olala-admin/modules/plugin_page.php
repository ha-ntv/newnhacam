				...
				<form action="?<?php echo TTH_PATH?>=plugin_page" method="post" enctype="multipart/form-data" id="deleteArt">
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right">
							...
							<input type="button" class="btn btn-danger btn-xs  <?php echo in_array("plugin_page_del",$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
