				...
				<form method="post" id="deleteArt">
							...
							<tr>
                                ...
                                <td align="center">
                                    <?php echo ($row["pin"]+0==0)?
                                        '<div class="btn-event-close" data-toggle="tooltip" data-placement="top" title="Mở" onclick="edit_status($(this), '.$row["article_id"].', \'pin\', \'article\');" rel="1">0</div>'
                                        :
                                        '<div class="btn-event-open" data-toggle="tooltip" data-placement="top" title="Đóng" onclick="edit_status($(this), '.$row["article_id"].', \'pin\', \'article\');" rel="0">1</div>'
                                    ?>
                                </td>
								<?php
								} else {
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right">
							...
							<input type="button" class="btn btn-danger btn-xs <?php echo in_array("article_del;".$category_id,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
