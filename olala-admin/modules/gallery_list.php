				...
				<form method="post" id="deleteArt">
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<td class="details-control" align="center">
									<div class="checkbox">
										<?php
										$href = ($gallery_menu_id==79) ? '?'.TTH_PATH.'=video_edit&id='.$row['gallery_id'] : '?'.TTH_PATH.'=gallery_edit&id='.$row['gallery_id'];
										?>
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right">
							...
							<input type="button" class="btn btn-danger btn-xs <?php echo in_array("gallery_del;".$category_id,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
