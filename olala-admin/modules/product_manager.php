...
<div class="row">
   <div class="col-lg-12" style="padding-top:15px;padding-bottom:15px;">
        <form  method="POST" action="?ol=product_list" name="form-product">
            <div class="row">
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-bottom:15px;">
                 <input class="form-control" type="text" name="name" value="" placeholder="Tên món ăn">
               </div>
               <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="margin-bottom:15px;">
                 <select name="is_active" class="form-control">
                       <option value="0">Chọn món show/hide</option>
               ...
               <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="margin-bottom:15px;">
                 <select name="status" class="form-control">
                     <option value="0">Chọn còn hàng/hết hàng</option>
                      <option value="2">Món còn hàng</option>
                     <option value="1">Món hết hàng</option>
                 </select>
               </div>
               <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="margin-bottom:15px;">
                 <select name="product_menu_id" class="form-control">
                     <option value="0">Chọn loại món</option>
                      <?php
                          ...
                          $db->condition = "category_id = 101 AND parent = 0";
                          $db->order = "";
                          $db->limit = "";
                          $ts = $db->select('product_menu_id,name');
                          foreach($ts as $tk) {
                             echo '<option value="'.$tk['product_menu_id'].'">'.$tk['name'].'</option>';
                          }
                      ?>
                 </select>
               </div>
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-bottom:15px;">
                 <input type="submit" name="filter_btn" class="btn btn-primary" value="Search">
               </div>
            </div>
        </form>
   </div>
...
<div class="row" style="margin: 20px">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<button type="button" data-toggle="modal" data-target="#_product_discount" onclick="return open_modal_product_discount();" id="multiple_discount" class="btn btn-success">Thêm discount hàng hoạt</button>
	</div>
</div>
	...
	foreach($rows2 as $row) {
	    ...
	    <tr>
            ...
            <td align="center">
	            ...
	            elseif($row["product_menu_id"] != 277) {
		            ?>
