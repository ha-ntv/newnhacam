...
//
$others_menu_id =  isset($_GET['id']) ? intval($_GET['id']) : 0;
$category_id = 0;
...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=others_manager"><i class="fa fa-puzzle-piece"></i> Mã giảm giá</a>
		</li>
		<li>
			<i class="fa fa-list"></i> <?php echo getNameMenu($others_menu_id, 'others')?>
		</li>
		<a class="btn-add-new" href="?<?php echo TTH_PATH?>=others_add&id=<?php echo $others_menu_id?>">Thêm mã</a>
	</ol>
</div>
<!-- /.row -->
				...
				<form method="post" id="deleteArt">
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right">
							...
							<input type="button" class="btn btn-danger btn-xs <?php echo in_array("others_del;".$category_id,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
