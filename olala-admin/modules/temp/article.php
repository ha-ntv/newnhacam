...
//
function article($act, $typeFunc, $article_id, $article_menu_id, $name, $slug, $title, $description, $keywords, $img, $img_note, $address, $price, $block, $flat, $open_sale, $type, $comment, $content, $youtube, $youtube_img, $tags, $is_active, $hot, $pin, $created_time, $upload_img_id, $error) {
	global $db, $tth;
	$category = 0;
			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover">
						...
						<tr>
							<td align="right"><label>Chuyên mục:</label></td>
						...
						<tr>
							...
							<td align="right"><label>Giá từ:</label></td>
						...
						<tr>
							...
							<td colspan="3">
                                <label class="radio-inline"><input type="radio" name="type" value="1" <?php echo $type==1?"checked":""?> > SẮP MỞ BÁN</label>
								<label class="radio-inline"><input type="radio" name="type" value="2" <?php echo $type==2?"checked":""?> > ĐANG MỞ BÁN</label>
								<label class="radio-inline"><input type="radio" name="type" value="3" <?php echo $type==3?"checked":""?> > ĐÃ BÁN HẾT</label>
							</td>
						</tr>
						<?php } ?>
						<tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="form-control" type="text" name="youtube" maxlength="255" value="<?php echo stripslashes($youtube)?>" >
                                <input type="hidden" name="youtube_img" value="<?php echo $youtube_img?>">
                            </td>
                        </tr>
                        <?php } ?>
						<tr>
