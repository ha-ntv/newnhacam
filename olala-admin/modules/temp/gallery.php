			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 80%;">
						...
						<tr>
							<td align="right" class="ver-top"><label>Hình ảnh kích thước (<?=$categoryID == 91? '1440px * 425px':'tỉ lệ 3 * 2' ?>):</label></td>
						...
						<tr>
							<td align="right"><label>Liên kết:</label></td>
						...
						<tr>
							...
							<td><input id="album" class="form-control file" type="file" name="images[]" data-max-file-count="15" accept="image/*" multiple></td>
						</tr>
						<tr>
