...
define([
  ...
  "underscore",
  "utils",
  "text!templates/healthymenu_delivery_item.html!strip",
  "text!templates/healthymenu_delivery_item_responsive.html!strip",
  "text!templates/cart_side_bar.html!strip",
  "text!templates/cart_list_responsive.html!strip",
  "cycle",
  "fancybox",
  "bootstrap",
  "bootstrap/spinedit",
  ...
  "match-height",
  "owlcarousel",
], function (global, head, $, _, utils, menu_item_template, healthymenu_delivery_item_responsive, cart_side_bar, cart_list_responsive){

  global("delivery", head, $, _, utils);
