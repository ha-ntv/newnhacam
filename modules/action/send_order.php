<?php
	...
	$txtsuggestion = $_POST['suggestion'];
	...
	$send_mail = sendMailFn($txtEmail, $txtName, $email_to, 'Phản hồi khách hàng', $subject, $message, '', $txtEmail, $txtName);
	//$send_mail1 = sendMailFn('kinkinthaifood@gmail.com', $txtName, 'kinkinthaifood@gmail.com', 'Phản hồi khách hàng', $subject, $message, '', 'kinkinthaifood@gmail.com', $txtName);
       if($send_mail == TRUE)
