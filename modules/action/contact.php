...
if(isset($_POST['send'])) {
	...
	$send_mail = sendMailFn($email, $name, $email_to, '', $subject, $message, '', $email, $name);
	if($send_mail == TRUE) echo $txtContact_sendOk;
